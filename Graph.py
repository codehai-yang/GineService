...
# ==================== 配置区 ====================
CSV_FILE = r"F:\office\idearProjects\project20251009\src\main\resources\branch_data.csv"  # 请修改为你的 CSV 路径
HEADER_STR = "sample_id,point_id,sum_price,wet_cost"

# 是否仅绘制湿区分支点（wet_cost > 0），若为 False 则绘制所有点（包括干区）
ONLY_WET = True

# 方案选择：若方案总数过多，可限制最多显示数量；设为 None 则显示全部
MAX_SAMPLES = 50  # 推荐不超过 30，否则线条过密；若需全部显示可设为较大值或 None

# 是否按单价排序每个方案内的点（建议 True，连线更有意义）
SORT_BY_PRICE = True

# 输出 HTML 文件名
OUTPUT_HTML = "wet_cost_interactive.html"

# 图表标题
CHART_TITLE = "多方案分支点湿区成本与单价关系图"
# =============================================
